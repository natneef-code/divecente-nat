...
Select any of the five roles at `/demo` without a password. The complete Open Water → booking → 10% demo deposit → portal → staff → calendar journey is working with fictional browser-local data. Phase 3 adds Fun Dive/Refresher, professional staffing and asset handling, CRM, training and document review. Phase 4 adds a Manager Dashboard, filterable reports, simulated notification previews, product/course administration, site/boat administration, general settings and searchable audit history. Feedback-dependent equipment, calendar and staffing UX is recorded as pending; production services remain documented backlog.
