...
export function operationsSeed(now = new Date()) {
  ...
  return {
    ...
    sessions: [] as Session[],
    boats: [
      { id: "boat-blue", name: "Blue Current", capacity: 12 },
      { id: "boat-willow", name: "Sea Willow", capacity: 12 },
      { id: "boat-shore", name: "Shore-based", capacity: 100 },
      { id: "boat-coral", name: "Coral Wind", capacity: 12 },
    ],
    diveSites: [
      {
        id: "site-reefs",
